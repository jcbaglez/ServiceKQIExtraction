...
class MacroLoL:
    ...
    def checkMoveHost(self, time, q = None):
        ...
        if (q != None):
            q.put(resp)
        return resp
    def getKQIs(self,mouseTime,name):
        ...
        latencyResults = dict()
        latencyResults = self.latencyFormatting("client",cLD)
